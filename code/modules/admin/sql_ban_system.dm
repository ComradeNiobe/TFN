...
/datum/admins/proc/ban_panel(player_key, player_ip, player_cid, role, duration = 1440, applies_to_admins, reason, edit_id, page, admin_key)
	...
	<div class='row'>
		...
		<div class='column middle'>
			...
			<div class='inputbox'></div></label>
			<br>
			<label class='inputlabel radio'>Pacifism
			<input type='radio' id='pacifism' name='radioban' value='pacifism'[role == "Server" ? "" : " checked"][edit_id ? " disabled" : ""]>
			<div class='inputbox'></div></label>
		</div>
